...
void sensoray826_dev::analogOversample()
{
   ...
   // printf("0aa %.3lf %.3lf %.3lf %.3lf %.3lf %.3lf \n", adcVoltages[0], adcVoltages[1], adcVoltages[2], adcVoltages[3], adcVoltages[4], adcVoltages[5]);
   // printf("1aa %.3lf %.3lf %.3lf %.3lf %.3lf %.3lf \n", adcVoltages[6], adcVoltages[7], adcVoltages[8], adcVoltages[9], adcVoltages[10], adcVoltages[11]);
   // printf("2aa %.3lf %.3lf %.3lf %.3lf  \n", adcVoltages[12], adcVoltages[13], adcVoltages[14], adcVoltages[15]);
}
